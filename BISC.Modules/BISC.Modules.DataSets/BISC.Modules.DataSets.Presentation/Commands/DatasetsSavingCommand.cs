...
{
	public class DatasetsSavingCommand : ISavingCommand
	{
		...
		public DatasetsSavingCommand(IDatasetModelService datasetModelService, IInfoModelService infoModelService, IDataSetFactory dataSetFactory,
		...
		public async Task<OperationResult<SavingCommandResultEnum>> SaveAsync()
		{
			try
			{
				...
				{
					if (_dataSetsToSave.Any((model => model.EditableNamePart == dataSetExiting.Name))) continue;
