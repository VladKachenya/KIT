...
namespace BISC.Modules.Connection.MMS
{
    public class IsoCotp
    {
        ...
        public async Task<CotpReceiveResult> Receive(Iec61850State iecs)
        {
            ...
            {
              await iecs.msMMS.WriteAsync(iecs.dataBuffer, 3, iecs.dataBufferIndex - 3);
        ...
        public async Task<int> SendInitAsync(Iec61850State iecs)
        {
            //Reset dstref
            Reset(iecs.cp);
           ...
           await IsoTpkt.SendAsync(iecs,true);
            return 0;
        }
